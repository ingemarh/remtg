...
butts(4)=uicontrol('Style','popupmenu','string','Kir|Sod|UHF|VHF|ESR1|ESR2|ESR3|Zod|Disk|Old','position',[145 0 55 20],'callback','datasel','tooltipstring','Data source','value',bval(4));
