...
butts(4)=uicontrol('Style','popupmenu','string','Kir|Sod|UHF|VHF|32m|42m|32p|Zod|Disk|Old','position',[145 0 55 20],'callback','datasel','tooltipstring','Data source','value',bval(4));
